...
Source: "dist\Configure AACSpeakHelper GUI\Configure AACSpeakHelper GUI.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\Configure AACSpeakHelper GUI\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: "{group}\Configure {#MyAppName} (GUI)"; Filename: "{app}\Configure AACSpeakHelper GUI.exe"
...
Name: "{autodesktop}\Configure AACSpeakHelper (GUI)"; Filename: "{app}\Configure AACSpeakHelper GUI.exe"; Tasks: desktopicon
...
Filename: "{app}\Configure AACSpeakHelper GUI.exe"; Description: "Launch GUI Configuration Tool"; Flags: nowait postinstall skipifsilent unchecked
