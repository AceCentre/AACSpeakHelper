...
REM Convert UI files using pyside6-uic from pyside6-tools
.venv\Scripts\pyside6-uic.exe GUI_TranslateAndTTS/form.ui -o GUI_TranslateAndTTS/ui_form.py
.venv\Scripts\pyside6-uic.exe GUI_TranslateAndTTS/item.ui -o GUI_TranslateAndTTS/item.py
