...
- Translate. *The most important thing is to set the original abd target language*. You can use the free service - which is [myMemory](http://mymemory.translated.net). If you find this poor coverage for your language pair then you can use a paid tier by putting in your keys into the app. [DeepL](https://www.deepl.com/translator) has good all round coverage and is well regarded. If you want thr translated string to be available to your AAC software tick the box to overwrite the pasteboard
